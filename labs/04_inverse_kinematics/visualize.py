...
# new positions
    # transform( np.array([.15, 0, .5]), np.array([pi/4,pi,pi])            ),
    # transform( np.array([0,   0, .75]),  np.array([0,pi,pi]) ),
    # transform( np.array([-.25, -.25, .6]),    np.array([-pi/2,pi,pi])            ),
    # transform( np.array([0, .5, .55]),    np.array([pi/4,pi/2,pi/2])            ),
    # transform( np.array([.2, -.6, 0.5]),  np.array([0,pi,pi/3])            ),
    # transform(np.array([-.1, -.2, .4]), np.array([0, np.pi, np.pi])),
    # transform(np.array([-.1, .2, .4]), np.array([np.pi/6, 5/6*np.pi, 7/6*np.pi])),
    # transform(np.array([.4, 0, .4]), np.array([0, np.pi, np.pi])),
    # transform(np.array([.6, 0, .4]), np.array([0, np.pi, np.pi])),
    # transform(np.array([.1, .5, 0.4]), np.array([0, np.pi, np.pi])),

# singularity
    # transform(np.array([8.80000000e-02, -2.57175828e-17, 8.23000000e-01]), np.array([0,pi,pi])),
     transform(np.array([0.562, -0.169, 0.5]), np.array([0,pi,pi])),
]
